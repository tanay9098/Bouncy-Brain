  ...
  return (
    <div className="auth-wrap">
      <form className="auth-card card" onSubmit={submit}>
        ...
        {!isLogin && <input className="input" placeholder="Your name" value={name} onChange={e=>setName(e.target.value)} required/>}
        ...
        <div className="switch">
          ...
          <span className="link-like" onClick={()=>setIsLogin(!isLogin)} style={{marginLeft:8}}>{isLogin? "Create":"Login"}</span>
        </div>
      </form>
    </div>
  );
